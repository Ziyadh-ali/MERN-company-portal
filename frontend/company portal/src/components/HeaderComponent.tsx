    ...
    return (<div className="flex justify-between items-center mb-6">
        ...
        <div className="flex items-center space-x-2">
            <DropdownMenu>
                ...
                <DropdownMenuContent>
                    <DropdownMenuItem onClick={() => navigate(role ==="employee" ? `/profile` : `/admin/profile`)}>Profile</DropdownMenuItem>
                    {role === "employee" && <DropdownMenuItem onClick={() => navigate(`/messages`)}>Messages</DropdownMenuItem>}
